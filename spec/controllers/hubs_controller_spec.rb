  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved hub as @hub" do
        ...
        post :create, {:hub => { "url" => "invalid value" }}, valid_session
        assigns(:hub).should be_a_new(Hub)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested hub" do
        ...
        Hub.any_instance.should_receive(:update).with({ "url" => "MyString" })
        put :update, {:id => hub.to_param, :hub => { "url" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the hub as @hub" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Hub.any_instance.stub(:save).and_return(false)
        put :update, {:id => hub.to_param, :hub => { "url" => "invalid value" }}, valid_session
        assigns(:hub).should eq(hub)
      end
